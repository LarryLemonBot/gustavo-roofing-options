...
const reportExpression = `(() => {
  ...
  return {
    ...
    offenders,
    trustCopy: (bodyTextLower.includes('family-owned roofing contractor') || bodyTextLower.includes('family-owned and operated')) && (bodyTextLower.includes('owner-led final review') || bodyTextLower.includes("vera's roofing owner review")),
