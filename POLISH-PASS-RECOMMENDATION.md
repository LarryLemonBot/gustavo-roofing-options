...
**Context:** Site polish to add FORTIFIED Home program-requirement conversations carefully, move services offered closer to the top, keep flow natural/customer-facing. Brand: black/deep plum/silver/white, approved logo, Brunswick County NC roofer. All services to surface per query. No unsupported guarantees/cert overclaims.
...
1. **Hero (immediate top, high visual + CTAs)**
   - Headline (kept strong): "Coastal roofing built to protect your property."
   - Intro: One paragraph that names the key offerings naturally: roof repairs, replacements, storm documentation, metal roofing, copper flashing, EPDM low-slope work, gutter cleaning, gutter guard installation, hand-nailed shingle work when in scope, and CertainTeed roof-system questions. Local (Brunswick County, wind/rain/humidity/salt air).
   - Chips (quick-scan services, 6 max): Roof repair, Replacements, Storm damage, Metal & copper, Gutters & guards, EPDM.
   - CTAs: Request an inspection, Call, See recent work.
   - Proof-strip (below hero, 3 items): Owner-led final review | Real job documentation | CertainTeed ShingleMaster.
   - Hero-card: "Request a roof inspection. Talk through the roof issue."
...
2. **Services Offered (first <main> section, #services - now the complete "what we do" right after hero/proof)**
   ...
   - Lead para: Mentions inspection requests, photos when useful, written scope, and practical recommendations. Lists the full set (tear-offs, repairs, FORTIFIED Home program questions when applicable, metal, copper, EPDM, cedar, gutters, guards, more) for Brunswick County.
   - 5 service cards (customer language, benefit + safe qualifiers, numbered 01-05):
     ...
     - 03 FORTIFIED Home program questions: Program requirements, wind-mitigation details, reinforced deck prep, and coastal reinforcement options discussed when they apply.
...
3. **Storm Ready (#storm, next for local relevance)**
   ...
   - Check-list: inspections/doc, metal/shingle/EPDM work, plain repair recs, FORTIFIED Home program requirements discussed when they apply, and photo documentation/written scopes for the homeowner's records.
...
5. **Craft / Why (owner differentiator)**
   ...
   - Updated items: Owner-led final review, hand-nailed shingles when included in scope, CertainTeed roof-system questions for eligible systems, copper & metal details, photo documentation, and FORTIFIED Home program requirements when applicable.
   - Quote-card: Enhanced to mention "careful hand-nailed fastening, owner inspection".

6. **Areas + Contact (close)**
   - Areas para: Updated to list key services + FORTIFIED Home program questions when applicable.
   - Contact para: Mirrors services + FORTIFIED Home program questions + warranty-option planning.
   - CTAs updated to inspection requests first, with phone/email/sms strong.

## Copy / Language Rules (enforced)
- FORTIFIED: "FORTIFIED Home program requirements when they apply" or "FORTIFIED Home program questions." Never "FORTIFIED certified", "FORTIFIED roofer", "FORTIFIED approved", or "we install FORTIFIED roofs" as a blanket certification/designation claim.
...
- Warranties: "eligible CertainTeed roof-system options", "manufacturer warranty questions", and "depends on current written terms, selected products, installation requirements, registration, property type, and transfer rules." Never blanket "includes 50-year warranty" or "backed by our labor" unless confirmed in the current written manufacturer terms.
...
- Review with owner: confirm FORTIFIED Home program wording, CertainTeed warranty wording, and hand-nailing scope language against the latest written proof.
